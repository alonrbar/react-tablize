...
var VirtualWindow = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function VirtualWindow(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "containerElement", React.createRef());
  ...
  _createClass(VirtualWindow, [{
    ...
    value: function render() {
      ...
      return (// outer element - container
        React.createElement(this.props.outerElementType, {
        ...
        React.createElement(this.props.innerElementType, {
...
})(exports.TileKey || (exports.TileKey = {}));
...
var Grid = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Grid(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderTile", function (tileKey) {
      ...
      return /*#__PURE__*/React.createElement(VirtualWindow, _extends({
        key: tileKey,
        ref: ref
  ...
  _createClass(Grid, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React.createElement(AutoSizer__default['default'], null, function (_ref) {
    ...
    value: function createTilesMap() {
      ...
      if (hasHeader) {
        if (hasFixedLeftColumn) {
          map[exports.TileKey.HeaderLeft] = createTilesMapEntry(exports.TileKey.HeaderLeft);
        }

        map[exports.TileKey.HeaderCenter] = createTilesMapEntry(exports.TileKey.HeaderCenter);

        if (hasFixedRightColumn) {
          map[exports.TileKey.HeaderRight] = createTilesMapEntry(exports.TileKey.HeaderRight);
        }
      } // body


      if (hasFixedLeftColumn) {
        map[exports.TileKey.BodyLeft] = createTilesMapEntry(exports.TileKey.BodyLeft);
      }

      map[exports.TileKey.BodyCenter] = createTilesMapEntry(exports.TileKey.BodyCenter);

      if (hasFixedRightColumn) {
        map[exports.TileKey.BodyRight] = createTilesMapEntry(exports.TileKey.BodyRight);
      } // footer


      if (hasFooter) {
        if (hasFixedLeftColumn) {
          map[exports.TileKey.FooterLeft] = createTilesMapEntry(exports.TileKey.FooterLeft);
        }

        map[exports.TileKey.FooterCenter] = createTilesMapEntry(exports.TileKey.FooterCenter);

        if (hasFixedRightColumn) {
          map[exports.TileKey.FooterRight] = createTilesMapEntry(exports.TileKey.FooterRight);
        }
      }
    ...
    value: function getBodyScrollableHeight() {
      ...
      var body = (_this$tiles$TileKey$B = this.tiles[exports.TileKey.BodyCenter]) === null || _this$tiles$TileKey$B === void 0 ? void 0 : (_this$tiles$TileKey$B2 = _this$tiles$TileKey$B.ref) === null || _this$tiles$TileKey$B2 === void 0 ? void 0 : _this$tiles$TileKey$B2.current;
    ...
    value: function getBodyScrollableWidth() {
      ...
      var body = (_this$tiles$TileKey$B3 = this.tiles[exports.TileKey.BodyCenter]) === null || _this$tiles$TileKey$B3 === void 0 ? void 0 : (_this$tiles$TileKey$B4 = _this$tiles$TileKey$B3.ref) === null || _this$tiles$TileKey$B4 === void 0 ? void 0 : _this$tiles$TileKey$B4.current;
...
var CustomScrollbarsInner = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(CustomScrollbarsInner, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Scrollbars__default['default'], {
        ref: refSetter,
...
var CustomScrollbars = React.forwardRef(function (props, ref) {
  return /*#__PURE__*/React.createElement(CustomScrollbarsInner, _extends({}, props, {
    forwardedRef: ref
  }));
});
...
var List = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(List, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(VirtualWindow, {
        ref: this.windowRef,
...
var TableBody = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(TableBody, null, [{
    ...
    value: function hasChildren(body) {
      ...
      var childrenCount = React.Children.count(body.props.children);
...
var TableCell = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(TableCell, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(TableContext.Consumer, null, function (ctx) {
        return /*#__PURE__*/React.createElement("div", _extends({}, _this.props, {
          style: _objectSpread2({}, ctx.isHead ? tableHeadCell(ctx.theme) : tableCell(ctx.theme), {}, _this.props.style)
        }), /*#__PURE__*/React.createElement(ErrorBoundary, null, _this.props.children));
      });
    }
  }], [{
    key: "isTableCell",
    value: function isTableCell(cell) {
      return React.isValidElement(cell) && cell.props[TableCellSymbol];
    }
  }, {
    key: "getCellProps",
...
var TableColumn = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(TableColumn, null, [{
    ...
    value: function createHeadFromColumns(columns) {
      ...
      var head = /*#__PURE__*/React.createElement(TableHead, null, columns.map(function (col) {
        var colHead = ReactUtils.singleChildOfType(col, ColumnHead);
        if (!colHead) return null; // eslint-disable-next-line react/jsx-key

        return /*#__PURE__*/React.createElement(TableCell, colHead.props);
      }));
      return head;
    }
  }, {
    ...
    value: function createBodyFromColumns(columns) {
      var body = /*#__PURE__*/React.createElement(TableBody, null, function (rowIndex) {
...
var TableRow = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(TableRow, [{
    ...
    value: function isTableRow(row) {
      return React.isValidElement(row) && row.props[TableRowSymbol];
    }
  }, {
    key: "getRowProps",
...
var Table = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Table() {
    ...
    _defineProperty(_assertThisInitialized(_this), "tableElement", React.createRef());
  ...
  _createClass(Table, [{
    ...
    value: function renderBody(head, body) {
      ...
      }, /*#__PURE__*/React.createElement(ErrorBoundary, null, showPlaceholder && this.renderRowsPlaceholder(), !showPlaceholder && /*#__PURE__*/React.createElement(AutoSizer__default['default'], null, function (_ref) {
        var width = _ref.width,
            height = _ref.height;
...
exports.ColumnBodyProps = ColumnBodyProps;
exports.ColumnHead = ColumnHead;
exports.Grid = Grid;
exports.GridProps = GridProps;
exports.List = List;
exports.RowAutoSize = RowAutoSize;
exports.Table = Table;
exports.TableBody = TableBody;
exports.TableBodyProps = TableBodyProps;
